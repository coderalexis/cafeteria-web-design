...
export const INDICE_ADMIN: DestinoAdmin[] = [
  ...
  { titulo: "Fijar un producto en el inicio del POS", donde: "Menú → Productos → Al tocar en el POS", href: "/admin/productos", palabras: "fijar inicio mas vendidos primera pantalla favoritos pos siempre visible" },
  { titulo: "Preguntar extras al tocar, por producto", donde: "Menú → Productos → Al tocar en el POS", href: "/admin/productos", palabras: "extras al tocar directo sin preguntar apagar pregunta leche americano entra directo" },
  ...
  { titulo: "Por cobrar (fiados)", donde: "Por cobrar", href: "/admin/por-cobrar", palabras: "fiado fiados por cobrar deben deuda cuenta pendiente cobrar despues perdonar saldo estado de cuenta abonos quien debe" },
  ...
  { titulo: "Sumar una ronda a una cuenta ya abierta", donde: "POS → Abrir cuenta → Cuentas abiertas", href: "/pos", palabras: "sumar agregar ronda cuenta abierta mismo nombre no duplicar juntar mesa ocupada chip mas total dos juanes otra persona mismo nombre guardar con la hora" },
  { titulo: "Separar una cuenta (cada quien paga lo suyo)", donde: "POS → cuenta abierta → Separar", href: "/pos", palabras: "separar dividir partir cuenta mesa entre varios somos dos cada quien paga lo suyo pagar por separado distintas formas de pago cobrar una parte dejar el resto" },
  { titulo: "Salir de una cuenta sin guardar los cambios", donde: "POS → cuenta abierta → Salir", href: "/pos", palabras: "salir vaciar carrito sin guardar descartar cambios me equivoque cantidad volver como estaba no borrar la cuenta" },
  { titulo: "Eliminar una cuenta (se canceló el pedido)", donde: "POS → cuenta abierta → bote", href: "/pos", palabras: "eliminar borrar descartar cuenta cancelo el pedido ya no lo quiere quitar mesa deshacerse bote basura vaciar la cuenta no la borra" },
  ...
  { titulo: "Existencias: qué cuenta tu café", donde: "Existencias", href: "/admin/existencias", palabras: "existencias inventario stock contar piezas pan botellas pasteles muffin cuantas quedan se esta acabando agotado minimo avisar" },
  { titulo: "Agregar un insumo (café en grano, vasos, servilletas)", donde: "Existencias → Agregar", href: "/admin/existencias", palabras: "insumo insumos cafe en grano granos leche vasos tapas servilletas azucar jarabes desechables popotes kilos litros paquetes cajas bolsas unidad materia prima" },
  { titulo: "Registrar una entrada (llegó mercancía)", donde: "Existencias → Entrada", href: "/admin/existencias", palabras: "entrada llego mercancia compra proveedor recibir pan insumos costo cuanto me costo actualizar costo gastos" },
  { titulo: "Registrar una merma (se perdió, caducó, cortesía)", donde: "Existencias → Merma", href: "/admin/existencias", palabras: "merma perdida se cayo se rompio caduco caducado cortesia consumo del personal regalado desperdicio" },
  { titulo: "Contar lo que hay (faltaron o sobraron)", donde: "Existencias → ⋯ → Contar lo que hay", href: "/admin/existencias", palabras: "contar conteo arqueo faltaron sobraron cuadrar existencias reales diferencia inventario semanal" },
  { titulo: "Historial de algo que cuentas (a dónde se fue)", donde: "Existencias → ⋯ → Historial", href: "/admin/existencias", palabras: "historial diario movimientos a donde se fueron compre y tengo estado de cuenta piezas kilos" },
