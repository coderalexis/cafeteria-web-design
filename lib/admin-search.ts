...
export const INDICE_ADMIN: DestinoAdmin[] = [
  ...
  { titulo: "Existencias: qué se cuenta por pieza", donde: "Existencias", href: "/admin/existencias", palabras: "existencias inventario stock piezas contar por pieza pan botellas pasteles muffin cuantas quedan se esta acabando agotado minimo avisar" },
  { titulo: "Registrar una entrada (llegó mercancía)", donde: "Existencias → Entrada", href: "/admin/existencias", palabras: "entrada llego mercancia compra proveedor recibir pan costo por pieza cuanto me costo actualizar costo" },
  ...
  { titulo: "Contar lo que hay (faltaron o sobraron)", donde: "Existencias → ⋯ → Contar lo que hay", href: "/admin/existencias", palabras: "contar conteo arqueo de piezas faltaron sobraron cuadrar existencias reales diferencia" },
  { titulo: "Historial de un artículo (a dónde se fueron)", donde: "Existencias → ⋯ → Historial", href: "/admin/existencias", palabras: "historial diario movimientos a donde se fueron compre y tengo estado de cuenta piezas" },
